...
namespace NutriApp5.Models.Busquedas
{
    public class BusquedaViewModel
    {
        ...
        public ICollection<int> condicionSelected;
        public ICollection<System.Web.Mvc.SelectListItem> arrayCondiciones;

        public int buscarEn;
        public ICollection<System.Web.Mvc.SelectListItem> arrayBuscarEn;
        ...
        public BusquedaViewModel()
        {
            ...
            this.condicionSelected = new List<int> ();
