...
using NutriApp5.Models.Productos;
...
{   
    public class PRODUCTOSController : Controller
    {
        ...
        private readonly IPRODUCTOSXCOMERCIORepository productosXcomercio = new PRODUCTOSXCOMERCIORepository();
        ...
        {
            productosXcomercio.DeleteAllComercioProductos(id);
